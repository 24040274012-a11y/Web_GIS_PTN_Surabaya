...
var lyr_PTNdiSurabaya_1 = new ol.layer.Vector({
    ...
    <img src="styles/legend/PTNdiSurabaya_1_9.png" /> <br />' });
...
var lyr_aksesibilitas_univunion_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/aksesibilitas_univunion_2_2.png" /> <br />' });

lyr_GoogleSatellite_0.setVisible(true);lyr_PTNdiSurabaya_1.setVisible(true);lyr_aksesibilitas_univunion_2.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_PTNdiSurabaya_1,lyr_aksesibilitas_univunion_2];
lyr_PTNdiSurabaya_1.set('fieldAliases', {'fid': 'fid', 'Nama': 'Nama', 'Kampus': 'Kampus', 'Rangking QS WUR': 'Rangking QS WUR', 'Tahun Berdiri': 'Tahun Berdiri', 'fakultas': 'fakultas', 'foto': 'foto', });
lyr_aksesibilitas_univunion_2.set('fieldAliases', {'fid': 'fid', 'Access': 'Access', });
lyr_PTNdiSurabaya_1.set('fieldImages', {'fid': 'TextEdit', 'Nama': 'TextEdit', 'Kampus': 'TextEdit', 'Rangking QS WUR': 'TextEdit', 'Tahun Berdiri': 'TextEdit', 'fakultas': 'TextEdit', 'foto': 'ExternalResource', });
lyr_aksesibilitas_univunion_2.set('fieldImages', {'fid': 'TextEdit', 'Access': 'TextEdit', });
lyr_PTNdiSurabaya_1.set('fieldLabels', {'fid': 'no label', 'Nama': 'no label', 'Kampus': 'no label', 'Rangking QS WUR': 'no label', 'Tahun Berdiri': 'no label', 'fakultas': 'no label', 'foto': 'inline label - always visible', });
